...
class EwmDecorationProvider implements FileDecorationProvider {
	...
	private collectDecorationData(group: EwmResourceGroup, bucket: Map<string, FileDecoration>): void {
